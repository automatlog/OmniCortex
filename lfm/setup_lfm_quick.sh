...
echo "========== SETUP COMPLETE =========="
echo ""
echo "Activate with: source ~/OmniCortex/.lfm-venv/bin/activate"
echo ""
echo "Start LFM server:"
echo "source ~/OmniCortex/.lfm-venv/bin/activate && python lfm/serve_lfm.py --host 0.0.0.0 --port 8012 --device cuda --preload"
