...
// In Next.js, the encoder worker must be served from public/
// Copy node_modules/opus-recorder/dist/encoderWorker.min.js to public/assets/
const encoderPath = "/assets/encoderWorker.min.js";
